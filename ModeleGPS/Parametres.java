...
public class Parametres {
	...
	public int getVolume() {
		return this.volumeCO;
	}
	
	public String getLast() {
		if(this.rapideDuree) return "duree plus courte" ;
		else return "distance plus courte";
 	}
	...
	// Echange si l'utilisateur souhaite ou une distance plus courte ou un trajet
	// plus rapide.
	public void echanger() {
		if (this.distancePlusCourte) {
			this.rapideDuree = true;
			this.distancePlusCourte = false;
		} else {
			this.rapideDuree = false;
			this.distancePlusCourte = true;
		}
	}
}